            ...
            <div className="space-y-6">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-500 text-sm">
                  Rất tiếc, đơn đăng ký đối tác của bạn không được chấp thuận
                </p>
              </div>
              ...
              <div className="space-y-3">
                <motion.button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-blue-500 hover:bg-blue-600 text-white font-semibold text-sm transition-all duration-200 shadow-md"
                >
