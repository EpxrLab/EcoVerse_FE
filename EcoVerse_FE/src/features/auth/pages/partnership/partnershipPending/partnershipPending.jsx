...
const StatusSteps = lazy(() =>
  Promise.resolve({
    default: function StatusSteps() {
      return (
        <div className="bg-[#f9faf6] rounded-[2rem] p-8 space-y-6 border border-[#1db1d1]/5">
          {/* Step 1 - Done */}
          <div className="flex items-start gap-4">
            <div className="w-8 h-8 rounded-full bg-[#1db1d1] flex items-center justify-center flex-shrink-0 mt-0.5 shadow-lg shadow-amber-900/20">
            ...
            <div>
              ...
              <p className="text-sm text-[#5b605c] font-greenhouse-body">
                Hồ sơ đối tác đã được hệ thống ghi nhận.
              </p>
            </div>
          </div>
          ...
          {/* Step 2 - In progress */}
          <div className="flex items-start gap-4">
            <div className="w-8 h-8 rounded-full bg-[#1db1d1] flex items-center justify-center flex-shrink-0 mt-0.5 shadow-lg shadow-amber-900/10">
              <Clock className="w-4 h-4 text-[#1db1d1]" />
            </div>
            <div>
              <p className="font-black text-[#2e3430] font-greenhouse-heading">Đang kiểm duyệt</p>
              <p className="text-sm text-[#5b605c] font-greenhouse-body">
                Ban quản trị đang thẩm định thông tin.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 opacity-40">
            ...
            <div>
              <p className="font-black text-[#5b605c] font-greenhouse-heading">Hợp tác</p>
              <p className="text-sm text-[#5b605c]/60 font-greenhouse-body">Bắt đầu hành trình cùng EcoVerse.</p>
            </div>
          </div>
        </div>
      );
            ...
            <div className="space-y-8">
              ...
              <div className="text-center">
                <motion.div
                  ...
                  className="w-24 h-24 mx-auto rounded-[2rem] bg-[#1db1d1]/20 flex items-center justify-center mb-6 shadow-inner"
                >
                  <Clock className="w-10 h-10 text-[#1db1d1]" />
                </motion.div>
                ...
                <p className="text-[#5b605c] font-greenhouse-body font-medium">
                  Hồ sơ đối tác đang được thẩm định
                </p>
              </div>
              ...
              <motion.div
                ...
                className="flex items-center gap-4 p-5 rounded-[2rem] bg-[#1db1d1]/10 border border-[#1db1d1]/5"
              >
                <Mail className="w-5 h-5 text-[#1db1d1] flex-shrink-0" />
                <p className="text-sm text-[#1db1d1] font-medium font-greenhouse-body">
