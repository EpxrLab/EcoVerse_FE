...
//         // Đánh bật sáng emissive để mô hình không bị chìm màu trên biển tối
//         t.traverse(child => {
...
//         // Thêm một vầng sáng nhỏ (Aura) bên dưới để dễ nhận biết
//         const catColors = {
//           RECYCLABLE: 0x2196f3,
//           ORGANIC: 0x4caf50,
//           HAZARDOUS: 0xf44336,
//           GENERAL: 0xeeeeee
//         };
//         const auraGeo = new THREE.CylinderGeometry(0.8, 0.8, 4, 16, 1, true);
