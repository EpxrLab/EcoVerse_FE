  ...
  const fetchCampaignDetail = async (id, origin = 'school') => {
    try {
      ...
      const mappedDetail = {
        ...
        start_date: toLocalISO(data.startDate || data.start_date),
        end_date: toLocalISO(data.endDate || data.end_date),
        invitation_send_date: toLocalISO(data.invitationDate || data.invitation_send_date),
        invitation_deadline: toLocalISO(data.invitationDeadline || data.invitation_deadline),
        registration_date: toLocalISO(data.registrationDate || data.registration_date),
        registration_deadline: toLocalISO(data.registrationDeadline || data.registration_deadline),
        ...
        rounds: data.rounds?.map(r => ({
          ...
          status: r.status,
          start_time: toLocalISO(r.startTime || r.start_time),
          end_time: toLocalISO(r.endTime || r.end_time),
